...
function RequestStatusBtn({ status }) {
    const buttonStyles = {
        ...
        pending: {
            ...
            icon: <MessageCircleWarning size={16} className="text-amber-500" />
        }
    };

    return (
        <div className={`flex flex-row gap-2 items-center justify-center px-2 py-1.5 rounded-md self-start border! ${buttonStyles[status].bgColor} ${buttonStyles[status].borderColor}`}>
